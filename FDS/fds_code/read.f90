...
REAL(EB) :: MW,SIGMALJ,EPSILONKLJ,VISCOSITY,CONDUCTIVITY,DIFFUSIVITY,MASS_EXTINCTION_COEFFICIENT, &
            ...
            CONVERSION,PR_GAS,CONDUCTIVITY_LIQUID,VISCOSITY_LIQUID,BETA_LIQUID
...
CHARACTER(LABEL_LENGTH) :: ID,FUNCTION_TYPE,INPUT_ID(40),RAMP_ID,ON_BOUND,RAMP_SP_1,RAMP_SP_2
...
NAMELIST /CTRL/  CONSTANT,CYCLES,CYCLE_TIME,DELAY,DIFFERENTIAL_GAIN,EVACUATION,FUNCTION_TYPE,ID,INITIAL_STATE,INTEGRAL_GAIN,&
                 ...
                 SETPOINT,TARGET_VALUE,TRIP_DIRECTION,RAMP_SP_1,RAMP_SP_2
...
READ_CTRL_LOOP: DO NC=1,N_CTRL
   ...
   CF%CYCLES          = CYCLES
   CF%RAMP_ID         = RAMP_ID
   CF%RAMP_SP_1       = RAMP_SP_1
   CF%RAMP_SP_2       = RAMP_SP_2
   CF%N               = N
   ...
   SELECT CASE(FUNCTION_TYPE)
      ...
      CASE('DEADBAND_TD')
         CF%CONTROL_INDEX = DEADBAND_TD
         CALL GET_RAMP_INDEX(RAMP_SP_1,'CONTROL',CF%SPI1)
         CALL GET_RAMP_INDEX(RAMP_SP_2,'CONTROL',CF%SPI2)
      CASE('CYCLING')
